...
-- CreateIndex
CREATE INDEX "Service_developerId_idx" ON "Service"("developerId");
...
-- CreateIndex
CREATE UNIQUE INDEX "OrderItem_orderId_serviceId_key" ON "OrderItem"("orderId", "serviceId");

-- AddForeignKey
ALTER TABLE "Profile" ADD CONSTRAINT "Profile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Service" ADD CONSTRAINT "Service_developerId_fkey" FOREIGN KEY ("developerId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
