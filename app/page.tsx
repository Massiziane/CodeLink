...
<div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-zinc-50 to-zinc-100 dark:from-black dark:to-zinc-950 px-6">
  ...
  {/* CARD */}
  <div className="w-full max-w-md rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-lg p-10 flex flex-col items-center text-center">
    ...
    <Link href="/cart" className="w-full block">
      <span className="flex items-center justify-center w-full py-3 rounded-xl bg-black text-white font-medium hover:bg-zinc-800 transition">
        Go to Cart Test →
      </span>
    </Link>
